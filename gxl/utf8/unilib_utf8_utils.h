...
#ifndef GXL_UTF8_UNILIB_UTF8_UTILS_H_
#define GXL_UTF8_UNILIB_UTF8_UTILS_H_
...
inline bool IsUTF8ValidCodepoint(absl::string_view str) {
  char32 c;
  int consumed;
...
#endif  // GXL_UTF8_UNILIB_UTF8_UTILS_H_
