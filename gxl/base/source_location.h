...
#ifndef GXL_SOURCE_LOCATION_H_
#define GXL_SOURCE_LOCATION_H_
...
class source_location {
 public:
  ...
  // used by the GXL_LOC macro, hence the name.
...
#define GXL_LOC gxl::source_location::DoNotInvokeDirectly(__LINE__, __FILE__)

#endif  // GXL_SOURCE_LOCATION_H_
