...
#ifndef GXL_BASE_ENDIAN_H_
#define GXL_BASE_ENDIAN_H_
...
#include "gxl/base/internal/unaligned_access.h"
...
inline int16_t FromHost(int16_t x) {
  return absl::bit_cast<int16_t>(FromHost16(absl::bit_cast<uint16_t>(x)));
}
inline int32_t FromHost(int32_t x) {
  return absl::bit_cast<int32_t>(FromHost32(absl::bit_cast<uint32_t>(x)));
}
inline int64_t FromHost(int64_t x) {
  return absl::bit_cast<int64_t>(FromHost64(absl::bit_cast<uint64_t>(x)));
}
inline int8_t ToHost(int8_t x) { return x; }
inline int16_t ToHost(int16_t x) {
  return absl::bit_cast<int16_t>(ToHost16(absl::bit_cast<uint16_t>(x)));
}
inline int32_t ToHost(int32_t x) {
  return absl::bit_cast<int32_t>(ToHost32(absl::bit_cast<uint32_t>(x)));
}
inline int64_t ToHost(int64_t x) {
  return absl::bit_cast<int64_t>(ToHost64(absl::bit_cast<uint64_t>(x)));
}
