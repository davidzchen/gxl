#ifndef GXL_STATUS_STATUS_MATCHERS_H_
#define GXL_STATUS_STATUS_MATCHERS_H_
...
//               StatusIs(absl::StatusCode::kCancelled, _));
//
...
//               StatusIs(Ne(absl::Status::kCancelled),
//                        HasSubstr("Cancelled"))));
//
// =============================
// StatusIs(status_code_matcher)
...
#endif  // GXL_STATUS_STATUS_MATCHERS_H_
