...
#ifndef ABXL_PROTOBUF_PROTOBUF_MATCHERS_H_
#define ABXL_PROTOBUF_PROTOBUF_MATCHERS_H_
...
private:
  ...
  std::string
  DescribeTypeMismatch(const google::protobuf::Message &expected,
...
private:
  void PrintExpected(std::ostream *os) const override {
    *os << expected_->GetTypeName();
    ...
    if (google::protobuf::TextFormat::PrintToString(*expected_,
                                                    &expected_string)) {
      *os << " -> {" << expected_string << "}";
    } else {
      *os << " (unknown value)";
  ...
  ExpectedProtoPtr
  CreateExpectedProto(const google::protobuf::Message &,
    ...
    return ExpectedProtoPtr(expected_.get(),
                            [](const google::protobuf::Message *) {});
  }

  // Helper function that creates a copy of the given Message.
  static std::shared_ptr<const google::protobuf::Message>
  CloneMessage(const google::protobuf::Message &msg) {
...
private:
  ...
  CreateExpectedProto(const google::protobuf::Message &arg,
    ...
    if (parser.ParseFromString(expected_, expected_proto.get())) {
      return ExpectedProtoPtr(
          expected_proto.release(),
      ...
      return ExpectedProtoPtr(nullptr,
                              [](const google::protobuf::Message *) {});
    }
  }
...
inline ::testing::PolymorphicMatcher<internal_proto::ProtoMatcher>
...
template <typename... Args> auto ElementsAreProtos(Args... args) {
  return ::testing::ElementsAre(EqualsProto(args)...);
}

// Defines an unordered equivalent to ElementsAreProtos.
template <typename... Args> auto UnorderedElementsAreProtos(Args... args) {
...
#endif // ABXL_PROTOBUF_PROTOBUF_MATCHERS_H_
