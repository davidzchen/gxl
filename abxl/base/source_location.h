...
#ifndef ABXL_SOURCE_LOCATION_H_
#define ABXL_SOURCE_LOCATION_H_
...
class source_location {
 public:
  ...
  // used by the ABXL_LOC macro, hence the name.
...
#define ABXL_LOC abxl::source_location::DoNotInvokeDirectly(__LINE__, __FILE__)

#endif  // ABXL_SOURCE_LOCATION_H_
