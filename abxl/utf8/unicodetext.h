...
#ifndef ABXL_UTF8_UNICODETEXT_H_
#define ABXL_UTF8_UNICODETEXT_H_
 ...
 public:
  ...
  class const_iterator {
   ...
   public:
    ...
    std::string get_utf8_string() const;
...
inline UnicodeText UTF8ToUnicodeText(const std::string& utf_string,
                                     bool do_copy) {
...
inline UnicodeText UTF8ToUnicodeText(const std::string& utf8_string) {
...
inline std::string UnicodeTextToUTF8(const UnicodeText& t) {
  return std::string(t.utf8_data(), t.utf8_length());
}

// Return a string_view that points to the UTF-8 encoded data in t.
inline absl::string_view UnicodeTextToStringView(const UnicodeText& t) {
  return absl::string_view(t.utf8_data(), t.utf8_length());
}
...
#endif  // ABXL_UTF8_UNICODETEXT_H_
